# Bug Assignment – Cihan Civan Yılmaz

Your program: **`even_odd_counter.py`**

## What should the program do?

The program asks for numbers until the user types `stop`. Then it prints how many even and how many odd numbers were entered.
...
```
Enter a number (stop to finish): 4
Enter a number (stop to finish): 7
Enter a number (stop to finish): 10
Enter a number (stop to finish): 3
Enter a number (stop to finish): 8
Enter a number (stop to finish): stop
Even numbers: 3
Odd numbers: 2
```
