# Bug Assignment – Özlem Açar

Your program: **`shopping_cart.py`**

## What should the program do?

The program asks for item prices until the user types 0. If the total is more than 150 TL, the customer gets a 15% discount. It prints the number of items, the total, the discount and the amount to pay.
