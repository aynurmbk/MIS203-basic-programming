# Bug Assignment – Hasan Mammadov

Your program: **`countdown.py`**

## What should the program do?

The program asks for a number and counts down from that number to 1. Then it prints `Go!` and the sum of all numbers in the countdown.
