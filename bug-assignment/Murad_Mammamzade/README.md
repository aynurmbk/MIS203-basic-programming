# Bug Assignment – Murad Mammamzade

Your program: **`atm.py`**

## What should the program do?

A simple ATM. The starting balance is 1000 TL. The user chooses `d` (deposit), `w` (withdraw) or `q` (quit). If the user wants to withdraw more than the balance, it prints `Not enough money!`. After each operation it prints the balance.
