# Bug Assignment – Aynur Mübek

Your program: **`password_checker.py`**

## What should the program do?

The correct password is `basic203`. The program asks for the password. If it is correct, it prints `Access granted!`. The user has 3 attempts. After 3 wrong attempts, it prints `Too many attempts. Account locked.`
