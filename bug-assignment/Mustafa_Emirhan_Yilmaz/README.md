# Bug Assignment – Mustafa Emirhan Yılmaz

Your program: **`multiplication_table.py`**

## What should the program do?

The program asks for a number and prints its multiplication table from 1 to 5. At the end it prints `Done!`.
