# Bug Assignment – Nilay Çorap

Your program: **`shopping_cart.py`**

## What should the program do?

The program asks for item prices until the user types 0. If the total is more than 250 TL, the customer gets a 15% discount. It prints the number of items, the total, the discount and the amount to pay.
...
```
Enter item price (0 to finish): 175
Enter item price (0 to finish): 75
