# Bug Assignment – Mehmet Sungur Mutlu

Your program: **`shopping_cart.py`**

## What should the program do?

The program asks for item prices until the user types 0. If the total is more than 100 TL, the customer gets a 10% discount. It prints the number of items, the total, the discount and the amount to pay.
...
```
Enter item price (0 to finish): 70
Enter item price (0 to finish): 30
Enter item price (0 to finish): 25
