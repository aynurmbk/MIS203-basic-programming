# Bug Assignment – Azra Yeniay

Your program: **`number_guess.py`**

## What should the program do?

The secret number is 39. The program asks the user to guess it. It prints `Too low!` or `Too high!` until the guess is correct. Then it prints how many tries it took.
...
Too low!
Guess the number (1-100): 39
Correct! You found it in 4 tries.
```
