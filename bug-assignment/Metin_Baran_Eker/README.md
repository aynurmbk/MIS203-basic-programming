# Bug Assignment – Metin Baran Eker

Your program: **`age_category.py`**

## What should the program do?

The program asks for ages until the user types `q`. For each age it prints: `Invalid age.` (below 0), `Child` (below 13), `Teenager` (below 18), `Adult` (below 65) or `Senior` (65 and above).
