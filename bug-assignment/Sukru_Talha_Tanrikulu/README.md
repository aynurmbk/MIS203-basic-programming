# Bug Assignment – Şükrü Talha Tanrıkulu

Your program: **`password_checker.py`**

## What should the program do?

The correct password is `mis2026`. The program asks for the password. If it is correct, it prints `Access granted!`. The user has 5 attempts. After 5 wrong attempts, it prints `Too many attempts. Account locked.`
