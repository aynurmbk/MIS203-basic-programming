# Bug Assignment – Öykü Naz Bilgen

Your program: **`average_grades.py`**

## What should the program do?

The program asks how many grades there are, then asks for each grade. It prints the average (2 decimal places). If the average is 60 or more, it prints `Result: PASSED`, otherwise `Result: FAILED`.
