# Bug Assignment – Ayşe Nur Kocatürk

Your program: **`number_guess.py`**

## What should the program do?

The secret number is 41. The program asks the user to guess it. It prints `Too low!` or `Too high!` until the guess is correct. Then it prints how many tries it took.
