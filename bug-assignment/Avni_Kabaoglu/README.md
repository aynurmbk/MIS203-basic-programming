# Bug Assignment – Avni Kabaoğlu

Your program: **`age_category.py`**

## What should the program do?

The program asks for ages until the user types `x`. For each age it prints: `Invalid age.` (below 0), `Child` (below 13), `Teenager` (below 18), `Adult` (below 65) or `Senior` (65 and above).
...
```
Enter age (x to quit): -1
Invalid age.
Enter age (x to quit): 5
Child
Enter age (x to quit): 15
Teenager
Enter age (x to quit): 30
Adult
Enter age (x to quit): 70
Senior
Enter age (x to quit): x
Goodbye!
```
