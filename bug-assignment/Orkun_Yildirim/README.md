# Bug Assignment – Orkun Yıldırım

Your program: **`countdown.py`**

## What should the program do?

The program asks for a number and counts down from that number to 1. Then it prints `Happy New Year!` and the sum of all numbers in the countdown.
