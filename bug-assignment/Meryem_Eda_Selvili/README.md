# Bug Assignment – Meryem Eda Selvili

Your program: **`average_grades.py`**

## What should the program do?

The program asks how many grades there are, then asks for each grade. It prints the average (2 decimal places). If the average is 50 or more, it prints `Result: PASSED`, otherwise `Result: FAILED`.
