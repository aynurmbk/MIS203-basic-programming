# Bug Assignment – Ferhat Aslangiri

Your program: **`even_odd_counter.py`**

## What should the program do?

The program asks for numbers until the user types `end`. Then it prints how many even and how many odd numbers were entered.
...
```
Enter a number (end to finish): 4
Enter a number (end to finish): 7
Enter a number (end to finish): 10
Enter a number (end to finish): 3
Enter a number (end to finish): 8
Enter a number (end to finish): end
Even numbers: 3
Odd numbers: 2
```
